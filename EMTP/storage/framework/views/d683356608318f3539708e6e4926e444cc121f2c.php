...
<?php $__env->startSection('content'); ?>
    ...
    <div class="bg-white">
        <section class="bg-white">
            <div class="max-w-5xl px-6 py-16 mx-auto bg-blue-500">
                <h2 class="text-3xl font-semibold text-gray-800">
                    About Expert Training Management Portal (EMTP)
                </h2>
                <p class="max-w-2xl mt-4 text-black">
                    Established since 2001 and has trained more than 50,000 people to improving their work productivity,
                ...
                <div class="grid gap-8 mt-10 md:mt-20 md:grid-cols-2">
                    <div class="flex space-x-4">
                        <svg class="w-10 h-10 text-gray-800" viewBox="0 0 50 50" fill="none"
                        ...
                        <div>
                            <h4 class="text-xl font-medium text-gray-800">Objectives</h4>
        ...
        <section class="bg-white">
            <div class="max-w-5xl px-6 py-16 mx-auto text-center">
                <h2 class="text-3xl font-semibold text-gray-800">A platform to improve yourself, <br>and others </h2>
                <p class="max-w-lg mx-auto mt-4 text-gray-600">
                    Use this opportunity to challenge and improve yourself in various skills and aspects such as your social
                    skills. Life is very unpredictable and requires us to think outside the box. Who
                    knows, you might get to know a new friend or two?
                </p>
                <img class="object-cover object-center w-full mt-16 rounded-md shadow h-80"
                    src="https://i.ibb.co/m4TF9ct/leon-6awf-TPLGa-CE-unsplash.jpg">
            </div>
        </section>
        <section class="bg-white">
            <div class="max-w-5xl px-6 py-16 mx-auto">
                <div class="px-8 py-12 bg-gray-800 rounded-md md:px-20 md:flex md:items-center md:justify-between">
                    <div>
                        <h3 class="text-2xl font-semibold text-white">Any Further Inquiries?</h3>
                        <p class="max-w-md mt-4 text-gray-400">
                            Click on the "Get Help" button to go to our support page should you have any inquiries.
                        </p>
                    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\LKW\Documents\GitHub\development_project_2\EMTP\resources\views/client/new/aboutus/index.blade.php ENDPATH**/ ?>