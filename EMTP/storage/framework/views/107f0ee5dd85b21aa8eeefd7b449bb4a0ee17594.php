                        ...
                        <div class="main-images mb-8  ">
                            <div class="images md:grid-cols-3 gap-8">
                                <div class="image bg-gray-400 rounded-lg shadow-lg overflow-hidden">
                                    <a href="<?php echo e(route('client.support.create')); ?>">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\LKW\Documents\GitHub\development_project_2\EMTP\resources\views/client/new/support/index.blade.php ENDPATH**/ ?>