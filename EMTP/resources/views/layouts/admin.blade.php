            ...
            <div class="flex flex-col flex-1 min-h-screen overflow-x-hidden overflow-y-auto">
              ...
              <header class="relative bg-white dark:bg-darker">
                <div class="flex items-center justify-between p-2 border-b dark:border-indigo-800">
                  ...
                  <a
                    href="#"
                    class="inline-block m-6 text-2xl font-bold tracking-wider text-indigo-700 uppercase dark:text-light"
                  >
                    EMTP
                  </a>
                  ...
                  <nav
                    ...
                    class="absolute flex items-center m-5 p-4 bg-white rounded-md shadow-lg dark:bg-darker top-16 inset-x-4 md:hidden"
