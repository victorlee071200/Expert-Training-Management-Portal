...
<div class="bg-white sm:rounded-lg flex">
    ...
    <div class="bg-gray-300 text-gray-800 hidden md:flex h-auto">
        <ul>
            ...
            <li>
                <a href="{{ route('staff.program-feedback', $assignedprograms->program_id) }}" class="hover:bg-white hover:text-indigo-600 px-7 md:px-16 lg:px-20 bg-white text-indigo-600 h-16 flex justify-center items-center w-auto">Feedback</a>
            </li>
        </ul>
    </div>
