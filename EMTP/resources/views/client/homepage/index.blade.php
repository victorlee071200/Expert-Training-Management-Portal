<x-app-layout title="EMTP - Homepage">
    <div class="bg-cover bg-left md:bg-left h-auto text-white py-24 px-10 object-left-top" style="background-image: url(https://www.denny.co.uk/wp-content/uploads/2016/04/in-house-training-banner.jpg)">
