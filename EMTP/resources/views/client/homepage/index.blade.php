<x-app-layout title="EMTP - Homepage">
    <div class="bg-cover bg-right-top md:bg-right-top h-auto sm:h-3/4 text-white py-24 px-10" style="background-image: url(https://i.ibb.co/8gbzPDJ/home-banner.jpg)">
        <div class="ml-5 md:ml-24 xl:ml-40 2xl:ml-60 bg-opacity-70 bg-gray-300 py-10 px-5 md:mr-40 lg:mr-60">
            ...
            <a href="{{ route('client-program-dashboard') }}" class="bg-purple-800 py-4 px-8 text-white font-bold uppercase text-xs rounded hover:bg-gray-200 hover:text-gray-800">Learn more</a>
        </div>
    </div>
    ...
    <div class="mx-5 md:mx-9 xl:mx-20">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4">
            <div class="hover:bg-gray-200 mx-2 my-2 border-gray-400 border text-center rounded-md">
                <img src="https://i.ibb.co/WWnKPbr/management.jpg" alt="management"/>
                <p class="font-bold text-lg pt-2 pb-5">Management</p>
            </div>
            <div class="hover:bg-gray-200 mx-2 my-2 border-gray-400 border text-center rounded-md">
                <img src="https://i.ibb.co/MNLd73j/software.jpg" alt="software"/>
                <p class="font-bold text-lg pt-2 pb-5">Software</p>
            </div>
            <div class="hover:bg-gray-200 mx-2 my-2 border-gray-400 border text-center rounded-md">
                <img src="https://i.ibb.co/HzGc4nq/creative.jpg" alt="creative"/>
                <p class="font-bold text-lg pt-2 pb-5">Creative</p>
            </div>
            <div class="hover:bg-gray-200 mx-2 my-2 border-gray-400 border text-center rounded-md">
                <img src="https://i.ibb.co/MhCFkMk/jobs.jpg" alt="jobs"/>
                <p class="font-bold text-lg pt-2 pb-5">Jobs</p>
            </div>
            <div class="hover:bg-gray-200 mx-2 my-2 border-gray-400 border text-center rounded-md">
                <img src="https://i.ibb.co/g9hW982/communication.jpg" alt="communication"/>
                <p class="font-bold text-lg pt-2 pb-5">Communication</p>
            </div>
            <div class="hover:bg-gray-200 mx-2 my-2 border-gray-400 border text-center rounded-md">
                <img src="https://i.ibb.co/94qyN5s/fitness.jpg" alt="fitness"/>
                <p class="font-bold text-lg pt-2 pb-5">Fitness</p>
            </div>
            <div class="hover:bg-gray-200 mx-2 my-2 border-gray-400 border text-center rounded-md">
                <img src="https://i.ibb.co/txncJVT/skills.jpg" alt="skills"/>
                <p class="font-bold text-lg pt-2 pb-5">Skills</p>
            </div>
            <div class="hover:bg-gray-200 mx-2 my-2 border-gray-400 border text-center rounded-md">
                <img src="https://i.ibb.co/4trDcpC/lifestyle.jpg" alt="lifestyle"/>
