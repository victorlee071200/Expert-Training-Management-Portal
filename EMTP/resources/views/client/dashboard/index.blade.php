  ...
  <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-1 mx-2">
      ...
      <div href="#" class="hover:bg-gray-100 lg:m-4 shadow-md hover:shadow-lg rounded-lg bg-white w-auto">
        ...
        <!-- Card Content -->
        <div class="p-4">
          <h3 class="font-medium text-gray-600 text-lg my-2 uppercase">{{$program->name}}</h3>
          <p class="text-justify">Provides basic fitness training every Monday morning Provides basic fitness training every Monday morning</p>
          <div class="mt-5">
