<x-app-layout>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-3">
        ...
        <div class="min-h-screen min-w-screen bg-gray-100 flex items-center justify-center">
            <div>
              <div class="flex flex-col max-w-1l bg-white px-8 py-6 rounded-xl space-y-5 items-center">
                  <!--Tag-->
                <p class="text-indigo-500 font-semibold text-base mt-2">Science</p>
                <!--Title-->
                <h1 class="font-semibold text-gray-900 leading-none text-xl mt-1 capitalize truncate">the life of albert einstein</h1>
        ...
        <!--First card-->
        <div class="md:p-8 p-2 bg-white hover:bg-gray-100">
          <!--Banner image-->
          <img
            class="h-50 rounded-lg w-full object-cover object-center"
        ...
        <!--Second Tag-->
        <div class="p-8 bg-white hover:bg-gray-100 ">
          <!--Banner image-->
          <img
            class="h-50 rounded-lg w-full object-cover object-center"
        ...
        <div class="p-8 bg-white hover:bg-gray-100">
          <!--Banner image-->
          <img class="h-50 rounded-lg w-full object-cover object-center" src="
