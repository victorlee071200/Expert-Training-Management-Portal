        ...
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
          ...
          <div class="m-10">
            ...
            <div  class="w-full max-w-lg">
                <form action="{{ route('admin.management.update', $staff->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="flex flex-wrap -mx-3 mb-6">
                        <div class="w-full px-3">
                          ...
                          <input id="name" class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" type="text" name="name" value="{{ $staff->name }}"/>
                        </div>
                      </div>
