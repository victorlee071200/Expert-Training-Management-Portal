    ...
    <div class="max-w-full mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
          ...
          <div class="m-10">
            ...
            <form method="POST" action="{{ route('admin.management.store') }}" class="w-full max-w-lg" enctype="multipart/form-data">
              @csrf
              ...
              <div class="flex flex-wrap -mx-3 mb-6">
                <div class="w-full px-3">
                  ...
                  <x-jet-input type="email" id="email" class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" type="email" name="email" required autofocus autocomplete="email" />
                </div>
              </div>
