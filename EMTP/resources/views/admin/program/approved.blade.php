                  ...
                  <div class="lg:w-4/5 mx-auto flex flex-wrap">
                    ...
                    <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                      ...
                      <div class="m-5">
                        <div class="col-md-4">
                          <button name="submit" >
                            <a href="/admin/view/program" class="block tracking-widest uppercase text-center shadow bg-blue-400 hover:bg-blue-500 focus:shadow-outline focus:outline-none text-white text-xs py-3 px-10 rounded">
                              Back
                            </a>
                          </button>
                        </div>
