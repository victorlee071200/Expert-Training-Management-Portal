        ...
        <form method="POST" action="{{ route('admin.program-announcement-update', [$program_details->id, $announcements->id]) }}" class="w-auto m-5" enctype="multipart/form-data">
            ...
            <div class="w-auto mx-3 mb-6">
                <div class="px-3">
                    ...
                    <textarea id="content" class="h-96 appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 focus:outline-none focus:bg-white focus:border-gray-500" type="text" name="content" required autofocus autocomplete="name">{{$announcements->content}}</textarea>
                </div>
            </div>
            <div class="w-auto mx-3 mb-6">
