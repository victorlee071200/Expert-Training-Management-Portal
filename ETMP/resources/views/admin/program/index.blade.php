                            ...
                            <tr class="transition-all hover:shadow-lg">
                                ...
                                <td class="py-3 px-6 text-center">
                                    <div class="flex item-center justify-center">
                                        <a class="font-medium " href="{{ url('/admin/program/approve/'. $program->id) }}">
                                        ...
                                        <form id="delete-user-form-{{ $program->id }}" action="{{ route('admin.program.destroy', $program->id) }}" method="POST" style="display: none">
                                            @csrf
                                            @method('DELETE')
                    ...
                    <tbody class="divide-y divide-gray-200">
                        @foreach ($approved as $program)
                            <tr class="transition-all hover:shadow-lg">
                                ...
                                <td class="py-3 px-6 text-center">
                                    <div class="flex item-center justify-center">
                                        <a class="font-medium " href="{{ url('/admin/program/approved/'. $program->id) }}">
                                            <div class="w-4 mr-2 transform hover:text-purple-500 hover:scale-110">
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" />
