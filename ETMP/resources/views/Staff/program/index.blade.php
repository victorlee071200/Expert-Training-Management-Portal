            ...
            <div class="overflow-hidden border-b border-gray-200 rounded-md shadow-md">
                ...
                <table class="min-w-full overflow-x-scroll divide-y divide-gray-200">
                    ...
                    <tbody class="divide-y divide-gray-200">
                        @foreach ($clientpending as $index => $program)
                            <tr class="transition-all hover:shadow-lg">
                                ...
                                <td class="py-3 px-6 text-center">
                                    <div class="flex item-center justify-center">
                                        <a class="font-medium " href="{{ url('/staff/program/'. $program->id) }}">
                        ...
                        @foreach ($pending as $program)
                            <tr class="transition-all hover:shadow-lg">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-center">
                                    ...
                                    <span class="text-sm font-medium">{{ $program->length }}</span>

                                </td>
                                <td class="px-6 py-4 text-sm whitespace-nowrap text-center">
                                    <span class="text-sm font-medium">{{ $program->price }}</span>
