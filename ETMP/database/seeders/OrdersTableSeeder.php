...
class OrdersTableSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('orders')->insert([
            ...
            'price' => 50.00,
            'purchased_program_id' => 1,
            'purchased_program_name' => 'English Beginner program',
        ...
        DB::table('orders')->insert([
            ...
            'user_email' => 'johnruth@admin.com',
            'price' => 55.00,
            'purchased_program_id' => 2,
            'purchased_program_name' => 'German Beginner program',
        ...
        DB::table('orders')->insert([
            ...
            'user_email' => 'johnruth@admin.com',
            'price' => 500.00,
            'purchased_program_id' => 3,
            'purchased_program_name' => 'German Preintermediate program',
